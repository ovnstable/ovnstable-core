...
contract StrategyDodoUsdt is Strategy, DodoExchange, BalancerExchange {
    ...
    event StrategyDodoUpdatedParams(address balancerVault, address dodoV1UsdcUsdtPool, address dodoV2DodoUsdtPool,
        address dodoMine, address dodoV1Helper, address dodoProxy, address dodoApprove);
    ...
    function setParams(
        ...
        emit StrategyDodoUpdatedParams(_balancerVault, _dodoV1UsdcUsdtPool, _dodoV2DodoUsdtPool, _dodoMine,
            _dodoV1Helper, _dodoProxy, _dodoApprove);
    }
