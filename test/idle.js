...
describe("Idle", function () {
    ...
    beforeEach(async () => {
        ...
        await deployments.fixture(['Vault', "Portfolio", 'Connectors', "Usdc2VimUsdTokenExchange", "setting-connectors", 'RewardManager', 'Mark2Market', 'PortfolioManager', 'Exchange', 'UsdPlusToken', 'SettingExchange', 'SettingUsdPlusToken', 'BuyUsdc']);
