...
describe("Idle", function () {
    ...
    beforeEach(async () => {
        ...
        await deployments.fixture(['Vault', "Portfolio", 'Connectors', 'RewardManager', 'Mark2Market', 'PortfolioManager', 'Exchange', 'UsdPlusToken', 'SettingExchange', 'SettingUsdPlusToken', 'BuyUsdc']);
