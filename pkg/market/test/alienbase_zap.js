...
describe("AlienBaseZapper", function () {
    ...
    const gauge = "0x52eaeCAC2402633d98b95213d0b473E069D86590";
    const poolId = 7;
    ...
    sharedBeforeEach('deploy and setup', async () => {
        ...
        await deployments.fixture(['AlienBaseZap']);

        account = await setUp();
        baseSwapZap = await ethers.getContract("AlienBaseZap");
