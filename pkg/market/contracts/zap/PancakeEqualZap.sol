...
contract PancakeEqualZap is OdosZap {
    ...
    function getProportion(
        ...
        uint256 amount1 = uint256(SqrtPriceMath.getAmount1Delta(TickMath.getSqrtRatioAtTick(tick - 4 * tickSpacing), sqrtRatioX96, int128(liquidity)));
