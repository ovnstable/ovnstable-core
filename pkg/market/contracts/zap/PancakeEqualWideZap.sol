...
contract PancakeEqualWideZap is OdosZap {
    ...
    function getProportion(
        ...
        uint256 amount0 = uint256(SqrtPriceMath.getAmount0Delta(sqrtRatioX96, TickMath.getSqrtRatioAtTick(upperTick), int128(liquidity)));
        uint256 amount1 = uint256(SqrtPriceMath.getAmount1Delta(TickMath.getSqrtRatioAtTick(lowerTick), sqrtRatioX96, int128(liquidity)));
