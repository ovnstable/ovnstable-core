 ...
 * Что делает скрипт?
 *
 * Передает права с dev аккаунта на timelock по OvnToken, OvnTimelockContoller.
 * - OvnGovernor передавать не нужно т.к. на нем нет прав.
 *
 * !!!! Перед передачей прав проверьте механизм создание proposal и изменение контрактов через timelock !!!!
 * !!!! В случае передачи прав вы потеряете возможно напрямую менять timelock и управлять протоколом    !!!!
 *
