...
contract ControlWmaticUsdc is Initializable, AccessControlUpgradeable, UUPSUpgradeable {

    bytes32 public constant UPGRADER_ROLE = keccak256("UPGRADER_ROLE");
    bytes32 public constant STRATEGY_ROLE = keccak256("STRATEGY_ROLE");

    StrategyWmaticUsdc public strategy;
    ...
    function setStrategy(address payable _strategy) external onlyStrategy{
        strategy = StrategyWmaticUsdc(_strategy);
        ...
        meshSwapWmaticUsdc = strategy.meshSwapWmaticUsdc();
