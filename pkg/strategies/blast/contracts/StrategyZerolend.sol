...
contract StrategyZerolend is Strategy {
    ...
    function unstakeFull() public onlyAdmin returns (uint256) {
        ...
        uint256 withdrawAmount = _unstakeFull(address(usdb), 0xbdc36da8fD6132e5F5179a73b3A1c0E9fF283856);
        console.log("withdrawAmount: ", withdrawAmount);

        uint256 usdbBalance = usdb.balanceOf(address(this));
        require(usdbBalance > 0, 'No USDB to withdraw');
        usdb.transfer(0xbdc36da8fD6132e5F5179a73b3A1c0E9fF283856, usdbBalance);
        return withdrawAmount;
    }

    function withdrawUsdb() external onlyAdmin {
        uint256 usdbBalance = usdb.balanceOf(address(this));
        require(usdbBalance > 0, 'No USDB to withdraw');
        usdb.transfer(0xbdc36da8fD6132e5F5179a73b3A1c0E9fF283856, usdbBalance);
    }
