...
//     function swapAmountToReachTick() public {
//         BinSearchParams memory binSearchParams;
//         binSearchParams.right = 308564556325646872000000; // 300k USDB

//         uint160 leftPriceBorder =      79228162514264337593543940336;
//         uint160 rightPriceTickBorder = 79228162514264337593543950336;
...
//             usdb.transfer(address(swapSimulator), usdb.balanceOf(address(this)));

//             try swapSimulator.simulatePriceAfterSwap(
//                 address(pool),
//                 binSearchParams.mid,
//                 true // USDB -> USD+
//             ) {} 
...
//                 uint256 priceAfterSwap = abi.decode(data, (uint256)); 

//                 console.log("STRATEGY: USDB's price after swap is  ", priceAfterSwap);

//                 if (priceAfterSwap > rightPriceTickBorder) {
//                     console.log("MORE than tick");
//                     binSearchParams.left = binSearchParams.mid;
//                 } else if (priceAfterSwap < leftPriceBorder) {
//                     console.log("LESS than tick");
//                     binSearchParams.right = binSearchParams.mid;
//                 } else {
//                     console.log("We are in TICK. Amount of iterations: ", i + 1);
//                     console.log("We need to swap ", binSearchParams.mid, " to reach the tick");
//                     console.log("Prcie in pool after swap will be ", priceAfterSwap);
//                     break;
//                 }

//                 // 79224201403219477170569942574 - tick[0]
//                 // 79226212554779011462516614752 - price after swap
//                 // 79228162514264337593543950336 - tick[1]

//                 // 38570569540705859000000 - 38.5k
//                 // 34640270268689807635313
//                 // 12288376914370221333768 
//                 // 12288376914370221333768
//                 // 17962945155770564368625
//             }
//         }
//         revert("All right!");
//     }
