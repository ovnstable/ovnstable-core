const { getContract, execTimelock, initWallet, getERC20ByAddress, transferETH } = require('@overnight-contracts/common/utils/script-utils');
...
async function main() {
    ...
    await execTimelock(async timelock => {
        ...
        (await strategy.connect(timelock).withdrawERC20(arbAddress, wallet.address, arbToClaim)).wait();
