...
let params =  {
    ...
    tickLower: -276325, // 0.999903
    tickUpper: -276324, // 1.000003
}
...
module.exports = async ({deployments}) => {
    ...
    await deploySection(async (name) => {
        await deployProxyMulti(name, 'StrategyUniV3Usdc', deployments, save, null);
    });
...
module.exports.tags = ['StrategyUniV3Usdc'];
