...
module.exports = async ({deployments}) => {
    ...
    await settingSection(async (strategy) => {
        ...
        console.log('GrantRole PORTFOLIO_AGENT_ROLE to ' + account);
        await (await strategy.grantRole(await strategy.PORTFOLIO_AGENT_ROLE(), account)).wait();
        await (await strategy.setSlippage(slippage)).wait();
    });
};
