...
module.exports = async () => {
    ...
    function velocore() {
        ...
        let items = [];
        items.push(createCustom('0x3F006B0493ff32B33be2809367F5F6722CB84a7b', usdPlus.address, 'USDC/USD+/USDT+', dex));
        items.push(createCustom('0xB30e7A2E6f7389cA5dDc714Da4c991b7A1dCC88e', usdtPlus.address, 'USDC/USD+/USDT+', dex));
