...
module.exports = async () => {
    ...
    await (await payoutManager.removeItem(usdPlus.address, '0x8E9154AC849e839d60299E85156bcb589De2693A')).wait();
    await (await payoutManager.removeItem(usdPlus.address, '0xE96c788E66a97Cf455f46C5b27786191fD3bC50B')).wait();
    await (await payoutManager.removeItem(usdcPlus.address, '0xE96c788E66a97Cf455f46C5b27786191fD3bC50B')).wait();
