...
module.exports = async ({deployments}) => {
    ...
    let implArtifact = await deployer.loadArtifact('UsdPlusTokenMigration');

    const contract = await deployer.deploy(implArtifact, []);
 
    await contract.deployed();
    console.log('UsdPlusTokenMigration deployed to:', contract.address); 
 

};

module.exports.tags = ['ZkSyncUsdPlusTokenMigration'];
