...
async function main() {
    ...
    let weights = [
        {
            "strategy": "0x2253BdD62eA63F7CBbf92785EEdcCAc7521FB6A1",
            "name": "Venus Usdc",
            "minWeight": 0,
            "targetWeight": 2.5,
            "maxWeight": 5,
        ...
        {
            "strategy": "0x642aB9e4AE1651EB1EF7407Aa3B89180FAeCB14e",
            "name": "Synapse Usdc",
            "minWeight": 0,
            "targetWeight": 97.5,
            "maxWeight": 100,
...
async function setWeights(weights) {
    let pm = await getContract('PortfolioManager', 'bsc_usdc');

    await (await pm.setCashStrategy("0x2253BdD62eA63F7CBbf92785EEdcCAc7521FB6A1")).wait();
