...
async function main() {
    ...
    let zerolend = await getContract('StrategyZerolend');
    let ez = await getERC20ByAddress(ZKSYNC.earlyZERO)
    ...
    console.log('earlyZERO reward balance before', fromE6(await ez.balanceOf(COMMON.rewardWallet)))
    console.log('earlyZERO strategy balance before', fromE6(await ez.balanceOf(zerolend.address)))
    ...
    await showM2M();  
    console.log('earlyZERO reward balance after', fromE6(await ez.balanceOf(COMMON.rewardWallet)))
    console.log('earlyZERO strategy balance after', fromE6(await ez.balanceOf(zerolend.address)))
}
