...
async function main() {
    ...
    await transferAsset(BASE.usdc, dev5Address, 10000000000);
    ...
    for (let i = 0; i < iterations; i++) {
        ...
        let cashTargetShare = (cashStrategyInitAmount / (swapStrategyInitAmount + i * N + cashStrategyInitAmount));
    ...
    let token0Balance = await sAsset.balanceOf(dev5Address);
    console.log("USDC balance at the end: " + token0Balance.toString());
}
