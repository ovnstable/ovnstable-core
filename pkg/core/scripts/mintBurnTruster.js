...
async function main() {
    ...
    console.log('trasury balance before', fromE18(await token.balanceOf(COMMON.rewardWallet)));
    console.log('pool balance before', fromE18(await token.balanceOf('0x147e7416d5988B097B3A1859eFECC2C5e04FDf96')));
