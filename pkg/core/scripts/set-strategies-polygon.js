...
async function main() {
    ...
    values.push(0);
    abis.push(pm.interface.encodeFunctionData('grantRole', [await pm.DEFAULT_ADMIN_ROLE(), '0x0bE3f37201699F00C21dCba18861ed4F60288E1D']))
    //
    ...
    //     values,
    //     abis,
    //     ethers.utils.id("Proposal: grantRole to Yarik"),
    //     {
