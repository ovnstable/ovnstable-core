...
* TODO added nukeSupply function
*/

contract UsdPlusTokenV1 is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function nukeSupply() external onlyAdmin {
        ...
        DystSwap dystSwap = DystSwap(0x3F18c87dc965ca8F5aB580Fc7F8446bCDb2E58a5); // change it later

        address pair1 = 0x421a018cC5839c4C0300AfB21C725776dc389B1a; // 25k
        address pair2 = 0x6c51df2275af37c407148e913B5396896E7E8E9e; // 406
        address pair3 = 0x1A5FEBA5D5846B3b840312Bd04D76ddaa6220170; // 345

        address tokenIn = address(this);
        address tokenOut1 = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; // USDC
        address tokenOut3 = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270; // WPOL

        uint256 amountIn1 = 100000 * decimals(); // 25k
        uint256 amountIn2 = 10000 * decimals(); // 406
        uint256 amountIn3 = 10000 * decimals(); // 345

        uint256 minAmountOut = 0;
        
        IERC20Upgradeable(address(this)).approve(address(dystSwap), amountIn1 + amountIn2 + amountIn3);

        dystSwap.swapOnPair(pair1, amountIn1, tokenIn, tokenOut1, minAmountOut, address(this));
        dystSwap.swapOnPair(pair2, amountIn2, tokenIn, tokenOut1, minAmountOut, address(this));
        dystSwap.swapOnPair(pair3, amountIn3, tokenIn, tokenOut3, minAmountOut, address(this));
