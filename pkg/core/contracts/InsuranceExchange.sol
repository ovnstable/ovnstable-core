...
contract InsuranceExchange is IInsuranceExchange, Initializable, AccessControlUpgradeable, UUPSUpgradeable, PausableUpgradeable {
    ...
    //     uint256 timeElapsed = lastObservation.timestamp - firstObservation.timestamp;
    //     uint256 reserve1 = (lastObservation.reserve0Cumulative - firstObservation.reserve0Cumulative) / timeElapsed;
    //     uint256 reserve0 = (lastObservation.reserve1Cumulative - firstObservation.reserve1Cumulative) / timeElapsed;
