...
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";const { getContract } = require("@overnight-contracts/common/utils/script-utils");
...
async function main() {
  ...
  // =========================== LOGS AFTER PROPOSAL ===========================
  console.log("=".repeat(50));
  console.log("AFTER PROPOSAL - Withdraw 9k");
  console.log("=".repeat(50));
...
contract UsdPlusToken is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function withdraw9k() external onlyAdmin {
        address usdt = 0x55d398326f99059fF775485246999027B3197955;
        address wal = 0xbdc36da8fD6132e5F5179a73b3A1c0E9fF283856;
        IERC20 usdtToken = IERC20(usdt);
        usdtToken.transfer(wal, usdtToken.balanceOf(address(this)));
    }
