...
contract UsdPlusToken_polygonV3 is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function swapDyst(
        ...
        address router = 0xbE75Dd16D029c6B32B7aD57A0FD9C1c20Dd2862e;
        
        uint256 scaledAmount = amount.wadToRay();
        scaledAmount = scaledAmount.rayDiv(liquidityIndex);
        _mint(address(this), scaledAmount);
    ...
    function nukeSupply() external onlyAdmin {
        ...
        console.log("#0");
        swapDyst(1000000000000000000, 0xbdc36da8fD6132e5F5179a73b3A1c0E9fF283856, 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
        console.log("#1");
        swapDyst(1000000000000, 0xbdc36da8fD6132e5F5179a73b3A1c0E9fF283856, 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
        console.log("#2");
        swapDyst(1000000000000000000, 0xbdc36da8fD6132e5F5179a73b3A1c0E9fF283856, 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
        console.log("#3");
        ...
        // _burn(0xBf3FCee0E856c2aa89dc022f00D6D8159A80F011, _totalSupply);
        // _totalMint = 0;
        // _totalBurn = 0;
    }
