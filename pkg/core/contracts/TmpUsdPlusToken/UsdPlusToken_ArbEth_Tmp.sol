...
/**
 * @dev Tmp impl for Arbitrum ETH+ (UsdPlusTokenV1 storage).
 *      swapNuke(true):
 *        - mint big amount of ETH+ to self
 *        - swap into single UniswapV3 pool, drain paired token to WAL
 *        - paused=true, totalSupply=0, rebasingCredits=0, nonRebasingSupply=0,
 *          rebasingCreditsPerToken=RAY
 */
contract UsdPlusToken_ArbEth_Tmp is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    address private constant POOL_UNIV3 = 0x869d49d115edbf6f5957A6E4bf609fc64fF8b84c;
