...
async function main() {
    ...
    let StrategyEtsTau = await getContract('StrategyEtsTau', 'optimism');

    addresses.push(PortfolioManager.address);
    values.push(0);
    abis.push(PortfolioManager.interface.encodeFunctionData('addStrategy', [StrategyEtsTau.address]));
