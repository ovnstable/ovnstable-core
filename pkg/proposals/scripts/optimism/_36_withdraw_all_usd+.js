...
//     const IUniswapV3Pool = require('@uniswap/v3-core/artifacts/contracts/interfaces/IUniswapV3Pool.sol/IUniswapV3Pool.json').abi;

//     async function logPoolInfo(address, label) {
//         const pool = await ethers.getContractAt(IUniswapV3Pool, address);
//         console.log(label);
...
//     await logPoolInfo('0x2582886F65EA71ECd3CFfD12089C55Fb9C75E9db', 'USD+/USDC.e');
//     await logPoolInfo('0xfC1505B3d4Cd16Bb2336394ad11071638710950F', 'USD+/OP');


//     // =============================================

//     await hre.network.provider.request({ method: 'hardhat_impersonateAccount', params: [devJun6] });
//     await hre.network.provider.send('hardhat_setBalance', [devJun6, '0x56BC75E2D63100000']); // 10 ETH
//     const devSigner = await ethers.getSigner(devJun6);
//     console.log('acting as', await devSigner.getAddress());
