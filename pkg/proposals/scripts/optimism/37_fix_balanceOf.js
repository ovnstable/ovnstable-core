...
async function main() {
  ...
  const UsdPlusToken = await getContract('UsdPlusToken', 'optimism');
  const DaiPlusToken = await getContract('DaiPlusToken', 'optimism_dai');
  ...
  addProposalItem(DaiPlusToken, 'upgradeTo', [newImplUsdPlus]);
