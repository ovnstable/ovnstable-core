...
async function main() {
    ...
    let upgradeTo = '0x96aa0bBe4D0dea7C4AF4739c53dBFA0300262253';
    ...
    addresses.push(usdPlus.address);
    values.push(0);
    abis.push(usdPlus.interface.encodeFunctionData('setRoleManager', [roleManager.address]));

    addresses.push(daiPlus.address);
    values.push(0);
    abis.push(daiPlus.interface.encodeFunctionData('setRoleManager', [roleManager.address]));

    addresses.push(ethPlus.address);
    values.push(0);
    abis.push(ethPlus.interface.encodeFunctionData('setRoleManager', [roleManager.address]));
