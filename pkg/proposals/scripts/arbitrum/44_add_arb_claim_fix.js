...
async function main() {
    ...
    let newImpl = "0x90A364Aa56a84E776649906C97b4077468CEd818";
    let operator = "0x899ce09fA986448fc00992Dc4A5E1c6ad528D6D9";

    addProposalItem(StrategySiloUsdc, 'upgradeTo', [newImpl]);
    ...
    addProposalItem(StrategySiloUsdcArb, 'upgradeTo', [newImpl]);
    ...
    addProposalItem(StrategySiloUsdcWbtc, 'upgradeTo', [newImpl]);
