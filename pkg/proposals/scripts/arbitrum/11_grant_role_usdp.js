...
async function main() {
    ...
    let wrapped = await getContract('WrappedUsdPlusToken', 'arbitrum');
    ...
    exchange = await getContract('Exchange', 'arbitrum_dai');
    usdPlus = await getContract('UsdPlusToken', 'arbitrum_dai');
    wrapped = await getContract('WrappedUsdPlusToken', 'arbitrum_dai');
    ...
    exchange = await getContract('Exchange', 'arbitrum_eth');
    usdPlus = await getContract('UsdPlusToken', 'arbitrum_eth');
    wrapped = await getContract('WrappedUsdPlusToken', 'arbitrum_eth');
