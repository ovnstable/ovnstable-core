...
async function main() {
  ...
  console.log("=".repeat(50));
  let contractBalanceBefore = await usdtToken.balanceOf(UsdtPlusToken.address);
  console.log(`USDT balance on contract ${UsdtPlusToken.address}: ${ethers.utils.formatUnits(contractBalanceBefore, 18)}`);
