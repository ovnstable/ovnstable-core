...
module.exports = async ({getNamedAccounts, deployments}) => {
    ...
    tx = await balancer.addActionBuilderAt(usdc2AUsdcActionBuilder.address, 2);
    await tx.wait();
    ...
    tx = await balancer.addActionBuilderAt(a3Crv2A3CrvGaugeActionBuilder.address, 3);
    await tx.wait();
    ...
    tx = await balancer.addActionBuilderAt(aUsdc2A3CrvActionBuilder.address, 4);
    await tx.wait();
    ...
    tx = await balancer.addActionBuilderAt(wMatic2UsdcActionBuilder.address, 5);
    await tx.wait();
    ...
    tx = await balancer.addActionBuilderAt(crv2UsdcActionBuilder.address, 6);
    await tx.wait();
