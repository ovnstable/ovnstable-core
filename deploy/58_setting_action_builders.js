...
module.exports = async ({getNamedAccounts, deployments}) => {
    ...
    await balancer.addActionBuilderAt(usdc2AUsdcActionBuilder.address, 1);
    ...
    await balancer.addActionBuilderAt(a3Crv2A3CrvGaugeActionBuilder.address, 2);
    ...
    await balancer.addActionBuilderAt(aUsdc2A3CrvActionBuilder.address, 3);
    ...
    await balancer.addActionBuilderAt(wMatic2UsdcActionBuilder.address, 4);
    ...
    await balancer.addActionBuilderAt(crv2UsdcActionBuilder.address, 5);
