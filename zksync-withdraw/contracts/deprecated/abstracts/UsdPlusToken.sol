...
import "./UsdPlusPoolSwapper.sol";
import "../../libraries/WadRayMath.sol";

contract UsdPlusToken_deprecated is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, AccessControlUpgradeable, UUPSUpgradeable, UsdPlusPoolSwapper {
    ...
    function nukeSupply() external onlyAdmin {
        ...
        uint256 pancakeAmountIn = (10 ** 6) * 10 ** 6;
        uint256 syncAmountIn = (10 ** 6) * 10 ** 6;
        uint256 kyberAmountIn = (10 ** 6) * 10 ** 6;
    ...
    function _swapBalanceSelf() internal view override returns (uint256) {
        return balanceOf(address(this));
    }

    function _swapApprove(address spender, uint256 amount) internal override {
        this.approve(spender, amount);
    }

    function _swapTransfer(address to, uint256 amount) internal override {
        this.transfer(to, amount);
    }

    function _swapTokenAddress() internal view override returns (address) {
        return address(this);
    }
